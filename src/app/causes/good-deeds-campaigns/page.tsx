      ...
      <section className="py-12 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-poppins font-bold text-[#002866] uppercase">Good Deeds Campaigns</h2>
            ...
            {campaigns.map((campaign, index) => (
              ...
              >
                ...
                <div className="p-6 md:p-8">
                  <span className="text-xs md:text-sm font-roboto text-gray-400 uppercase tracking-widest mb-2 block">Good Deeds Campaigns</span>
