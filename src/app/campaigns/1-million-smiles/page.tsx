          ...
          >
            {steps.map((step, index) => (
              <motion.div 
                ...
                className="bg-white p-10 rounded-sm shadow-lg hover:-translate-y-2 transition-transform duration-300 relative group"
              >
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div 
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6 }}
            className="relative aspect-video bg-gray-900 rounded-sm overflow-hidden shadow-2xl mb-12 group cursor-pointer"
          >
            <Image 
          ...
          <motion.h3 
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="text-2xl font-poppins font-bold text-[#002866] mb-8"
          >
          ...
          <motion.button 
            ...
            className="bg-[#ff9f22] text-[#002866] px-12 py-5 font-black uppercase tracking-[0.2em] shadow-xl hover:shadow-[#ff9f22]/20 transition-all"
          >
