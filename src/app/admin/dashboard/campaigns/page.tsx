  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-100">
        <h2 className="text-2xl font-poppins font-bold text-[#002866]">Manage Campaigns</h2>
      ...
      <div className="flex flex-col items-center justify-center h-64 text-gray-400 bg-gray-50 border border-dashed border-gray-200 rounded-sm">
        <p className="mb-2 font-bold text-gray-500 uppercase tracking-widest text-sm">No campaigns active.</p>
        <p className="text-sm">Click "Add New Campaign" to create a new one.</p>
      </div>
    </motion.div>
  );
}