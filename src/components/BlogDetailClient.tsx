          ...
          <div className="flex flex-col lg:flex-row gap-10">
              ...
              >
                ...
                <div className="p-6 md:p-10">
                  ...
                  <div className="pt-10 border-t border-gray-100">
                    <Link href="/blog" className="inline-flex items-center text-brand-primary font-bold hover:text-brand-secondary transition-colors">
            ...
            <div className="lg:w-1/3 space-y-10">
              ...
              <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-sm">
                <h3 className="text-xl font-poppins font-bold text-[#002866] mb-6 pb-3 border-b-2 border-[#ff9f22] inline-block">Recent News</h3>
