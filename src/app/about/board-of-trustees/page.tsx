...
export default function BoardOfTrustees() {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      <h6 className="text-[#ff9f22] font-bold tracking-widest uppercase mb-4">
        Our Leadership
      </h6>

      <h2 className="text-3xl md:text-4xl lg:text-5xl font-poppins font-bold text-[#002866] uppercase">
        Board of Trustees
      </h2>
      ...
      {members.map((member) => (
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-[11px] md:text-xs font-roboto text-gray-500 uppercase tracking-[0.15em] font-semibold leading-relaxed">
              {member.role}
            </p>

            {member.extra && (
              <p className="text-sm md:text-[15px] text-[#002866] font-semibold leading-relaxed">
                {member.extra}
              </p>
            )}
          </div>
