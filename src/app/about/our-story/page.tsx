      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h6 className="text-[#FFEE00] font-bold tracking-[0.3em] uppercase mb-4">Who We Are</h6>
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-roboto">
                ...
                <div className="bg-[#002866] text-white p-8 border-l-8 border-[#FFEE00] italic shadow-xl">
            ...
            <div className="relative h-[600px]">
              ...
              />
              <div className="absolute -bottom-8 -left-8 bg-[#FFEE00] p-12 hidden md:block shadow-xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {focusAreas.map((area, index) => (
              <div key={index} className="bg-white p-10 rounded-sm shadow-md hover:shadow-xl transition-all border-b-4 border-transparent hover:border-[#FFEE00] group text-center">
                <div className="w-16 h-16 bg-[#002866] text-[#FFEE00] rounded-full flex items-center justify-center text-2xl font-black mb-6 mx-auto group-hover:scale-110 transition-transform">
                  0{index + 1}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div className="space-y-8">
              <h2 className="text-4xl font-poppins font-bold uppercase tracking-tight text-[#FFEE00]">Our Vision</h2>
            ...
            <div className="space-y-12">
              <h2 className="text-4xl font-poppins font-bold uppercase tracking-tight text-[#FFEE00]">Core Values</h2>
