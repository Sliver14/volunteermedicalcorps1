...
export default async function EventDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="w-full bg-white font-roboto">
      <PageBanner title={event.title} parent={{ label: "Events", href: "/media/events" }} />
        ...
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
          ...
          <div className="bg-gray-50 p-8 md:p-12 rounded-sm border border-gray-100 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/about/contacts" className="bg-white text-[#002866] border-2 border-[#002866] px-10 py-4 font-black uppercase tracking-widest text-sm hover:bg-[#002866] hover:text-white transition-all shadow-sm rounded-sm">
                Contact Us
              </Link>
            </div>
          </div>
